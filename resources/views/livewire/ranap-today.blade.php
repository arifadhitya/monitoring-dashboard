<div>
    <div class="flex flex-col gap-8">
        <div class="flex items-center gap-2">
                ...
                <strong class="font-bold text-2xl">Rawat inap hari ini</strong>
            </div>
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-row gap-5">
                    <div class="flex flex-col">
                        <strong class="text-xl font-bold">Antri Ranap</strong>
                        <span class="text-xl">{{ $jumlahAntrianRanap }} Pasien</span>
                    </div>
                    <div class="flex flex-col">
                        <strong class="text-xl font-bold">IGD</strong>
                        <span class="text-xl">{{ $jumlahIGD }} Pasien</span>
                    </div>
                </div>
            </div>
